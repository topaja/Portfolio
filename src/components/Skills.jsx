    ...
    <>
      <div className="py-10 relative">
        ...
        <div className="flex items-center justify-center w-full gap-6">
          <div className="w-20 bg-light-primary h-1 mt-2 rounded"></div>
          <p className="text-light-primary font-secondary font-bold text-[22px] w-fit">
            My Skills
          </p>
          <div className="w-20 bg-light-primary h-1 mr-3 mt-2 rounded"></div>
        </div>
        <div className="flex flex-wrap justify-center gap-10 px-8 py-20 sm:mx-[10%]">
