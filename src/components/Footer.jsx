      ...
      <footer className="px-2 sm:px-8 h-fit pt-15">
        <div className="h-full bg-[#DCDBF8] rounded-t-[80px] mx-auto p-4 flex flex-col gap-2">
          <ul className="text-light-text font-primary flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mt-4 text-lg">
            <li className="hover:font-medium hover:text-light-primary delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ease-in-out">
              About
            </li>
            <li className="hover:font-medium hover:text-light-primary delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ease-in-out">
              Skills
            ...
            <li className="py-1 sm:py-2 hover:font-medium hover:text-light-primary delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ease-in-out">
              Contact
            </li>
          </ul>
